...
Đồ án thuộc môn **CS117 - Computational Thinking**, giải quyết bài toán:
chủ phòng gym khó xác định thiết bị nào đang được sử dụng nhiều, khung giờ
nào quá tải, và thiết bị nào cần bảo trì. Việc lượng hóa cần được thực hiện khoa học trước khi đưa ra các quyết định, do đó đề tàu hạn chế tính cảm tính nếu chỉ dựa vào quan sát thủ công.
