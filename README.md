...
“Hệ thống đo lường thời gian chiếm dụng từng thiết bị tại phòng gym”

Đồ án thuộc môn **CS117 - Computational Thinking**. Đề tài hướng đến việc xây dựng một hệ thống tự động phân tích video từ camera giám sát có sẵn tại phòng gym, nhằm đo lường và thống kê tổng thời gian mà mỗi thiết bị tập luyện bị chiếm dụng. Kết quả đầu ra giúp chủ phòng gym có dữ liệu định lượng cụ thể để ra quyết định về đầu tư, bố trí mặt bằng, điều phối vận hành và lên lịch bảo trì thiết bị một cách khoa học, thay vì dựa vào cảm tính hoặc quan sát thủ công. 
